# main-sim-dv-scale-high.R: script to run a set of simulations to assess identifiability
...
save(psi.mean.samples, psi.low.samples, psi.high.samples,
     ...
     psi.true, beta, scenario.vals, file = 'results/sim-dv-scale-high-results.rda')
