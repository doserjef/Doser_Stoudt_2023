# main-sim-sv-no-det-scale-low.R: script to run a set of simulations to assess identifiability
...
# Load the data sets
load("data/sim-data-scale-low.rda")
dat.full <- dat
...
save(psi.mean.samples, psi.low.samples, psi.high.samples,
     ...
     psi.true, beta, scenario.vals, file = 'results/sim-sv-no-det-scale-low-results.rda')
