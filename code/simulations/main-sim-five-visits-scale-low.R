# main-sim-five-visits-scale-low.R: script to run a set of simulations to assess identifiability
#                                   of a five-visit multi-season occupancy model under varying
...
save(psi.mean.samples, psi.low.samples, psi.high.samples,
     ...
     psi.true, beta, scenario.vals, file = 'results/sim-five-visits-scale-low-results.rda')
