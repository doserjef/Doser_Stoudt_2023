# main-sim-sv-no-det-probit.R: script to run a set of simulations to assess identifiability
#                              occupancy probability using a logistic regression model that
#                              ignores detection probability across various
...
save(psi.mean.samples, psi.low.samples, psi.high.samples,
     ...
     psi.true, beta, scenario.vals, file = 'results/sim-sv-no-det-probit-results.rda')
