# main-sim-dv-probit.R: script to run a set of simulations to assess identifiability
...
#                data that are misspecified with a probit link function.
...
save(psi.mean.samples, psi.low.samples, psi.high.samples,
     ...
     psi.true, beta, scenario.vals, file = 'results/sim-dv-probit-results.rda')
