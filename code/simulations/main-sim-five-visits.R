# main-sim-five-visits.R: script to run a set of simulations to assess identifiability
#                         of a multi-season occupancy model with five visits under varying
...
save(psi.mean.samples, psi.low.samples, psi.high.samples,
     ...
     psi.true, beta, scenario.vals, file = 'results/sim-five-visits-stPGOcc-results.rda')
