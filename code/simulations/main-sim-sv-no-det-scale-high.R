# main-sim-sv-no-det-scale-high.R: script to run a set of simulations to assess identifiability
...
# Load the data sets
load("data/sim-data-scale-high.rda")
dat.full <- dat
...
save(psi.mean.samples, psi.low.samples, psi.high.samples,
     ...
     psi.true, beta, scenario.vals, file = 'results/sim-sv-no-det-scale-high-results.rda')
