# main-sim-five-visits-line.R: script to run a set of simulations to assess identifiability
#                              of a five-visit multi-season occupancy model under varying
#                              levels of spatial and temporal autocorrelation. This generates
#                              data that are misspecified using a linar relationship forced to 
#                              be between 0 and 1. 
...
save(psi.mean.samples, psi.low.samples, psi.high.samples,
     ...
     psi.true, beta, scenario.vals, file = 'results/sim-five-visits-line-results.rda')
