# main-sim-mixed-probit.R: script to run a set of simulations to assess identifiability
...
save(psi.mean.samples, psi.low.samples, psi.high.samples,
     ...
     psi.true, beta, scenario.vals, file = 'results/sim-mixed-probit-results.rda')
